  ...
  return (
    <div className="w-full pt-5">
      <div className="flex justify-center text-blue-600  ">
        <div data-aos='fade-up' className="w-[350px] h-[340px] bg-[#2B2929] p-4 text-white flex flex-col items-center cursor-pointer hover:bg-white hover:text-black ease-in-out duration-500 hover:drop-shadow-lg   ">
